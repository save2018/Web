...
<div id="dcHead">
 <div id="head">
  <div class="logo"><a href="index.php" title="WEB管理系统">WEB管理系统</a></div>
  <div class="box">
   <ul class="siteName">
   ...
   <ul class="nav">
    <li style="display:none;"><a href="module.php"<?php if ($this->_tpl_vars['cur'] == 'module'): ?> class="cur"<?php endif; ?>><?php echo $this->_tpl_vars['lang']['top_module']; ?>
<?php if ($this->_tpl_vars['unum']['module']): ?><span class="unum"><span><?php echo $this->_tpl_vars['unum']['module']; ?>
</span></span><?php endif; ?></a></li>
   <li style="display:none;"><a href="../index.php" target="_blank"><?php echo $this->_tpl_vars['lang']['top_go_site']; ?>
</a></li>

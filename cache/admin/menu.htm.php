<?php /* Smarty version 2.6.26, created on 2018-12-27 10:00:56
         compiled from menu.htm */ ?>
<div id="menu">
 <ul class="top">
  <li><a href="index.php"><i class="home"></i><em><?php echo $this->_tpl_vars['lang']['menu_home']; ?>
<?php if ($this->_tpl_vars['unum']['system']): ?><span class="unum"><span style="display:none"><?php echo $this->_tpl_vars['unum']['system']; ?>
 ...
 <ul>
  ...
  -->
  <li<?php if ($this->_tpl_vars['cur'] == 'nav'): ?> class="cur"<?php endif; ?> style="display:none"><a href="nav.php"><i class="nav"></i><em><?php echo $this->_tpl_vars['lang']['nav']; ?>
</em></a></li>
  <li<?php if ($this->_tpl_vars['cur'] == 'show'): ?> class="cur"<?php endif; ?> style="display:none"><a href="show.php"><i class="show"></i><em><?php echo $this->_tpl_vars['lang']['show']; ?>
</em></a></li>
  <li<?php if ($this->_tpl_vars['cur'] == 'page'): ?> class="cur"<?php endif; ?> style="display:none"><a href="page.php"><i class="page"></i><em><?php echo $this->_tpl_vars['lang']['menu_page']; ?>
</em></a></li>
 </ul>
...
"></i><em><?php echo $this->_tpl_vars['menu']['lang']; ?>
   ...
   <li <?php if ($this->_tpl_vars['cur'] == $this->_tpl_vars['menu']['name_category']): ?> class="cur"<?php endif; ?>  style="display:none;"><a href="<?php echo $this->_tpl_vars['menu']['name_category']; ?>
.php"><i class="<?php echo $this->_tpl_vars['menu']['name']; ?>
...
<?php if ($this->_tpl_vars['menu']['name'] == 'plugin'): ?><?php if ($this->_tpl_vars['unum']['plugin']): ?><span class="unum"><span><?php echo $this->_tpl_vars['unum']['plugin']; ?>
 ...
 <?php endif; ?>
 <ul class="bot">
  <li<?php if ($this->_tpl_vars['cur'] == 'backup'): ?> class="cur"<?php endif; ?> style="display:none"><a href="backup.php"><i class="backup"></i><em><?php echo $this->_tpl_vars['lang']['backup']; ?>
</em></a></li>
  <li<?php if ($this->_tpl_vars['cur'] == 'mobile'): ?> class="cur"<?php endif; ?> style="display:none"><a href="mobile.php"><i class="mobile"></i><em><?php echo $this->_tpl_vars['lang']['mobile']; ?>
</em></a></li>
  <li<?php if ($this->_tpl_vars['cur'] == 'theme'): ?> class="cur"<?php endif; ?> style="display:none"><a href="theme.php"><i class="theme"></i><em><?php echo $this->_tpl_vars['lang']['theme']; ?>
